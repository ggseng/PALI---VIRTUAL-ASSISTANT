...
def search_web(input):
    driver = webdriver.Firefox(executable_path=r'C:\Users\Roni\Anaconda3\geckodriver.exe')
...
def process_text(input):
    try:
        if "who are you" in input or "define yourself" in input:
            speak = '''Hello, I am Pali. Your one and only personal Assistant.
            I am here to make your life too much easier. 
            You can command me to perform various tasks such as calculating sums or opening applications like things'''
            assistant_speaks(speak)
            return
        elif "who made you" in input or "created you" in input:
            speak = "I have been created by Rounak Sengupta."
            assistant_speaks(speak)
            return
        elif "crazy" in input:
